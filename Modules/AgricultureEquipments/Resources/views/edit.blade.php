                                                ...
                                                <div class="single-page-content single-content">
                                                    ...
                                                    <article id="post-1148" class="post-1148 page type-page status-publish cactus-single-content">
                                                        <div class="body-content">
                                                            ...
                                                            @foreach($edit_equipment as $equipment)
                                                            <form action="/agricultureequipments/update-equipment/{{$equipment->id}}" method="get" class="wpcf7-for" enctype="multipart/form-data">
                                                                @csrf

                                                                Equipment Name
                                                                <span class="wpcf7-form-control-wrap your-email">
                                                                    <input type="text" name="equipment" value="{{$equipment->equipment}}" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required />
                                                                </span>
                                                                Quantity
                                                                <span class="wpcf7-form-control-wrap your-email">
                                                                    <input type="text" name="quantity" value="{{$equipment->quantity}}" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required />
                                                                </span>
                                                                Price
                                                                <span class="wpcf7-form-control-wrap your-email">
                                                                    ...
                                                                    Description
                                                                <span class="wpcf7-form-control-wrap your-email">
                                                                    <input type="text" name="description" value="{{$equipment->description}}" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required />
                                                                </span>
