                                                                                        ...
                                                                                        <div class="wpb_wrapper">
                                                                                            <div class="wpb_text_column wpb_content_element  vc_custom_1469602300039 textwidget" >
                                                                                                <div class="wpb_wrapper">
                                                                                                    ...
                                                                                                    <span class="wpcf7-form-control-wrap your-email">
                                                                                                    <input type="text" name="price" value="{{$property->price}}" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" required />
                                                                                                    </span>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
