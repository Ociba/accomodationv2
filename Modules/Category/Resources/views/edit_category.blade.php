                                                ...
                                                <div class="single-page-content single-content">
                                                    ...
                                                    <article id="post-1148" class="post-1148 page type-page status-publish cactus-single-content">
                                                        <div class="body-content">
                                                            ...
                                                            <form  action="/category/update-category/{{$category->id}}" class="wpcf7-for" enctype="multipart/form-data">   
                                                            @csrf  
                                                                <div style="display: none;">
                                                                    <input type="hidden" name="created_by" value="{{auth()->user()->id}}">
                                                                   
                                                                </div>
                                                                <input type="hidden" name="id" value="{{$category->id}}" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email">
                                                                <p>
                                                                    Category
