        ...
        <div class="main-content-col-body">
           @include('layouts.accomodation-crumb')
            ...
            <div class="channel-banner">
                <div class="channel-banner-content" style="background-image:url(/images/house.jpg);">
                    ...
                    <div class="channel-button " id="">
                        ...
                        <span class="font-size-1 metadata-font sub-count meta-2">                
                         @php
                            $count_houses =DB::table('properties')->where('category_id',3)->count();
                        @endphp                
                        | {{$count_houses}} House(s)		
                        </span>
                    </div>
                </div>
                        ...
                        <article class="cactus-post-item hentry">
                            <div class="entry-content">
                                    ...
                                    <div class="picture-content screenshots-preview-inlin" data-post-id="1570">
                                        <a href="#" target="_self"  title=" 1 Room in Agip,Soroti, ugx:150,000 Per Month">
                                            <div class="screenshots"><img
                                                src="{{ asset('property_photos/'.$house->photo)}}" style="width: 636px; height:150px;"
                                ...
                                <div class="content">
                                    ...
                                    <span style="color:#333399;"> {{$house->category_name}}</span> {{$house->bedroom}} Room. {{$house->property_status}} <br> ugx:{{$house->price}} Per month
                                    </h3>
                                    <!--Title-->
                                    <!--excerpt (remove)-->
                                    <div class="excerpt sub-lineheight" >
                                          <i class="fas fa-map-marker-alt"></i>  {{$house->location}}<br>
                                             ...
                                             <div class="login-msg">
                                                <div class="login-content" style="text-align:center;">
                                                    <span class="login-info">
                                                        <strong><i class="fa fa-phone-volume"></i> {{$house->contact}}</strong>                        
                                                    </span>
                                                </span>
                                                </div>
                                            </div>
