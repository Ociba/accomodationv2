        ...
        <div class="main-content-col-body">
           @include('layouts.accomodation-crumb')
            ...
            <div class="channel-banner">
                <div class="channel-banner-content" style="background-image:url(/images/plots.jpg);">
                    ...
                    <div class="channel-button " id="">
                        ...
                        @php
                            $count_plots_and_land=DB::table('properties')->where('category_id',6)
                            ->orwhere('category_id',7)->count();
                        @endphp                
                        | {{$count_plots_and_land}} Plot & Land (s)		
                        </span>
                    </div>
                </div>
            ...
            <div class="cactus-listing-wrap switch-view-enable">
                <div class="cactus-listing-config style-2 style-channel-listing">
                    ...
                    <div class="cactus-sub-wrap">
                        @foreach($plots_and_land as $plotsland)
                        <article class="cactus-post-item hentry">
                            <div class="entry-content">
                                    ...
                                    <div class="picture-content screenshots-preview-inlin" data-post-id="1570">
                                        <a href="#" target="_self"  title=" 1 Room in Agip,Soroti, ugx:150,000 Per Month">
                                            <div class="screenshots"><img
                                                src="{{ asset('property_photos/'.$plotsland->photo)}}" style="width: 636px; height:150px;"
                                ...
                                <div class="content">
                                    ...
                                    <span style="color:#333399;"> {{$plotsland->category_name}}</span>,Size: {{$plotsland->property_size}}, {{$plotsland->property_status}} <br> ugx:{{$plotsland->price}}
                                    </h3>
                                    <!--Title-->
                                    <!--excerpt (remove)-->
                                    <div class="excerpt sub-lineheight" >
                                          <i class="fas fa-map-marker-alt"></i>  {{$plotsland->location}}<br>
                                             ...
                                             <div class="login-msg">
                                                <div class="login-content" style="text-align:center;">
                                                    <span class="login-info">
                                                        <strong><i class="fa fa-phone-volume"></i> {{$plotsland->contact}}</strong>                        
                                                    </span>
                                                </span>
                                                </div>
                                            </div>
