        ...
        <div class="vc_row wpb_row vc_row-fluid vc_custom_1469089899584 vc_row-has-fill">
                <div class="wpb_column vc_column_container vc_col-sm-6 vc_col-has-fill">
                    <div class="vc_column-inner vc_custom_1469089852378">
                        ...
                        <span style="font-weight:bold; color:black; ">Update Your Profile Now</span>
                        </div>
                    </div>
                </div>
        </div>
       
        <form name="registerform" id="registerform" action="/update-profile" method="get">
            @csrf         
            <div class="vc_row wpb_row vc_row-fluid vc_custom_1469089899584 vc_row-has-fill">
                <div class="wpb_column vc_column_container vc_col-sm-6 vc_col-has-fill">
                    <div class="vc_column-inner vc_custom_1469089852378">
                        <div class="wpb_wrappe">
                            ...
                            <input type="email" name="email" id="name" class="input" value="" size="20" />
                        </div>
                    </div>
                </div>
                @php
            ...
            <div>
                <button type="submit" class="btn btn-primary mb-1" style="padding:5px;">Update Profile</a>
            </div>
        </form>
    </div>
    <!--Content-->
