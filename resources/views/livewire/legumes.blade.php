                            ...
                            <div class="entry-content">
                                ...
                                <div class="picture">
                                    <div class="picture-content screenshots-preview-inlin" data-post-id="1570">
                                        <a href="/" target="_self"  title=" 1 legume in Agip,Soroti, ugx:150,000 Per Month">
                                            <div class="screenshots"><img style="height:150px; width: 636px;"
                                                src="{{ asset('produce_photos/'.$legume->image)}}"
                                            ...
                                            <div class="badges-group">
                                                <div class="badges-item">
                                                    <img src="../../wp-content/uploads/2016/05/12-015-Video-Badges_03.png" alt=" 1 legume in Agip,Soroti, ugx:150,000 Per Month">
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <div class="content" style="text-align:center;">
                                    ...
                                    <h3 class="cactus-post-title entry-title h4"> 
                                        <span style="color:#333399;"> {{$legume->produce_name}}</span> | {{$legume->quantity}} <br> ugx:{{$legume->price}}
                                    </h3>
                                    <!--Title-->
                                    <!--excerpt (remove)-->
                                    <div class="excerpt sub-lineheight" >
                                          <i class="fas fa-map-marker-alt"></i>  {{$legume->address}}<br>
                                             ...
                                             <div class="login-msg">
                                                <div class="login-content" style="text-align:center;">
                                                    <span class="login-info">
                                                        <strong><i class="fa fa-phone-volume"></i> {{$legume->phone_number}}</strong>                        
                                                    </span>
                                                </span>
                                                </div>
                                            </div>
