                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="picture">
                                            <div class="picture-content">
                                                <a href="/" target="_self" title="shoes">
                                                    <img 
                                                        data-src="{{ asset('super_market_photos/'.$shoe->photo)}}" style="height:200px;"
                                        ...
                                        <div class="content text-center">
                                            ...
                                            <div class="posted-on metadata-font text-center">
                                                <div class="cactus-info font-size-4" style="color:blue; font-weight:bold;"><span>Ugx: {{ number_format($shoe->price)}}</span></div>
                                            </div>
                                            <div class="posted-on metadata-font text-center">
