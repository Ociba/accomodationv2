                    ...
                    <div class="block-wrap ajax-container active tab-active" data-filter="0" data-paged="1">
                        <div class="cactus-listing-config style-2">
                            ...
                            <div class="cactus-sub-wrap">
                                <!--item listing-->                                                
                                <!--item listing-->  
                                @foreach($electronics as $elect)                                              
                                <article class="cactus-post-item">
                                    <div class="entry-content">
                                        <!--picture (remove)-->
                                        <div class="picture">
                                            <div class="picture-content">
                                                <a href="/" target="_self" title="electronics">
                                                    <img 
                                                        data-src="{{ asset('super_market_photos/'.$elect->photo)}}" style="height:200px;"
                                                ...
                                                <div class="cactus-note font-size-1"><i class="fa fa-thumbs-up"></i><span>{{$elect->item}}</span></div>
                                        ...
                                        <div class="content text-center">
                                            ...
                                            <div class="posted-on metadata-font text-center">
                                                <div class="cactus-info font-size-4" style="color:blue; font-weight:bold;"><span>Ugx: {{ number_format($elect->price)}}</span></div>
                                            </div>
                                            <div class="posted-on metadata-font text-center">
                                            <div class="cactus-info font-size-1">
                                                    <span>
                                                        <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="hidden" value="{{ $elect->id }}" name="id">
                                                            <input type="hidden" value="{{ $elect->item }}" name="name">
                                                            <input type="hidden" value="{{ $elect->price }}" name="price">
                                                            <input type="hidden" value="{{ $elect->photo }}"  name="image">
