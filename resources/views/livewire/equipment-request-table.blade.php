                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/agricultureequipments/more-on-customer-order/{{$order->id}}"  class="btn btn-info mb-1">View</a>
                                            <a href="/agricultureequipments/print-order/{{$order->id}}"  class="btn btn-success mb-1">Print</a>
                                            <a href="/agricultureequipments/mark-customer-order-as-delivered/{{$order->id}}"  class="btn btn-indigo mb-1">Delivered</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
