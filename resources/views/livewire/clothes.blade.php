                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="picture">
                                            <div class="picture-content">
                                                <a href="/" target="_self" title="Clothes">
                                                    <img 
                                                        data-src="{{ asset('super_market_photos/'.$cloth->photo)}}" style="height:200px;"
                                                ...
                                                <div class="cactus-note font-size-1"><i class="fa fa-thumbs-up"></i><span>{{$cloth->item}}</span></div>
                                        ...
                                        <div class="content text-center">
                                            ...
                                            <div class="posted-on metadata-font text-center">
                                                <div class="cactus-info font-size-4" style="color:blue; font-weight:bold;"><span>Ugx: {{ number_format($cloth->price)}}</span></div>
                                            </div>
                                            <div class="posted-on metadata-font text-center">
                                                <div class="cactus-info font-size-1">
                                                    <span>
                                                        <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <input type="hidden" value="{{ $cloth->item }}" name="name">
                                                            <input type="hidden" value="{{ $cloth->price }}" name="price">
                                                            <input type="hidden" value="{{ $cloth->photo }}"  name="image">
