                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="picture">
                                            <div class="picture-content">
                                                <a href="/" target="_self" title="schools">
                                                    <img 
                                                        data-src="{{ asset('super_market_photos/'.$school->photo)}}" style="height:200px;"
                                                ...
                                                <div class="cactus-note font-size-1"><i class="fa fa-thumbs-up"></i><span>{{$school->item}}</span></div>
                                        ...
                                        <div class="content text-center">
                                            ...
                                            <div class="posted-on metadata-font text-center">
                                                <div class="cactus-info font-size-4" style="color:blue; font-weight:bold;"><span>Ugx: {{ number_format($school->price)}}</span></div>
                                            </div>
                                            <div class="posted-on metadata-font text-center">
                                            <div class="cactus-info font-size-1">
                                                    <span>
                                                        <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <input type="hidden" value="{{ $school->item }}" name="name">
                                                            <input type="hidden" value="{{ $school->price }}" name="price">
                                                            <input type="hidden" value="{{ $school->photo }}"  name="image">
