                    ...
                    <div class="block-wrap ajax-container active tab-active" data-filter="0" data-paged="1">
                        <div class="cactus-listing-config style-2">
                            ...
                            <div class="cactus-sub-wrap">
                                <!--item listing-->                                                
                                <!--item listing-->  
                                @foreach($beddings as $beds)                                              
                                <article class="cactus-post-item">
                                    <div class="entry-content">
                                        <!--picture (remove)-->
                                        <div class="picture">
                                            <div class="picture-content">
                                                <a href="/" target="_self" title=$beddings">
                                                    <img 
                                                        data-src="{{ asset('super_market_photos/'.$beds->photo)}}" style="height:200px;"
                                                ...
                                                <div class="cactus-note font-size-1"><i class="fa fa-thumbs-up"></i><span>{{$beds->item}}</span></div>
