                                    ...
                                    <div class="entry-content">
                                        ...
                                        <div class="picture">
                                            <div class="picture-content">
                                                <a href="/" target="_self" title="drinks">
                                                    <img 
                                                        data-src="{{ asset('super_market_photos/'.$drink->photo)}}" style="height:200px;"
                                                ...
                                                <div class="cactus-note font-size-1"><i class="fa fa-thumbs-up"></i><span>{{$drink->item}}</span></div>
                                        ...
                                        <div class="content text-center">
                                            ...
                                            <div class="posted-on metadata-font text-center">
                                                <div class="cactus-info font-size-4" style="color:blue; font-weight:bold;"><span>Ugx: {{ number_format($drink->price)}}</span></div>
                                            </div>
                                            <div class="posted-on metadata-font text-center">
                                            <div class="cactus-info font-size-1">
                                                    <span>
                                                        <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <input type="hidden" value="{{ $drink->item }}" name="name">
                                                            <input type="hidden" value="{{ $drink->price }}" name="price">
                                                            <input type="hidden" value="{{ $drink->photo }}"  name="image">
