<div>
                            ...
                            <div class="wpb_column vc_column_container vc_col-sm-4 vc_col-has-fill">
                                <div class="vc_column-inner vc_custom_1469089860166">
                                    <div class="wpb_wrapper">
                                        ...
                                        Search Entries
                                        <span class="wpcf7-form-control-wrap your-email">
                                           <input type="email" value="" size="40" wire:model="searchTerm" /></span>
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="wpb_wrapper" style="overflow-x:auto;">
                            <table class="table">
                                <tbody>
                                    ...
                                    @foreach($supermarket_items as $i=>$supermarket)
                                    <tr>
                                         @php
                                        if( $supermarket_items->currentPage() == 1){
                                        $i = $i+1;
                                        }else{
                                        $i = ($i+1) + 10*($supermarket_items->currentPage()-1);
                                        }
                                        @endphp
                                        <td>{{$i}}</td>
    ...
    <span>Add Supermarket Items</span>
    </a>
    </div>
    </div>
    </div>
