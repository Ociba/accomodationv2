            ...
            <ul>
                ...
                <li id="nav-menu-item-1446" class="main-menu-item menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children parent dropdown">
                    ...
                    <ul class="dropdown-menu menu-depth-1">
                        ...
                        <li id="nav-menu-item-2311" class="sub-menu-item menu-item-depth-1 menu-item menu-item-type-post_type menu-item-object-post"><a href="/supermarket/supermarket-order-summary" class="menu-link  sub-menu-link">Orders Summary</a></li>
                    </ul>
                </li>
                <li id="nav-menu-item-1446" class="main-menu-item menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children parent dropdown">
                ...
                <li id="nav-menu-item-1589" class="main-menu-item menu-item-depth-0 menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children parent dropdown">
                    <a href="/income/" class="menu-link dropdown-toggle disabled main-menu-link" ><i class="fa fa-dollar-sign"></i> Income </a>
                </li>
            </ul>
        </nav>
    </div>
