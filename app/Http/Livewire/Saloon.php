...
class Saloon extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.saloon',[
            'saloons' =>Items::join('supermarket_categories','supermarket_categories.id','supermarkets.item_group_id')
            ->where('item','like',$searchTerm)
            ->where('supermarkets.item_group_id',4)
